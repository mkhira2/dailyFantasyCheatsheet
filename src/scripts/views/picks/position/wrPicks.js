...
var WRpicks = React.createClass({
	render: function() {
    if (this.props.showWRPicks === false) {
      return null
    }
		return (
			<div className='stat-container'>
			    ...
			    <table id="complete" className="tablesorter">
						<Headers />
						<Body wrPicks={ACTIONS.wrPicks(this.props.wrData)} />
			    </table>
	      </div>
...
var Body = React.createClass({
	render: function() {
		return (
			<tbody >
        {this.props.wrPicks.map(function(player, i) {
            return (
              <tr key={i}>
